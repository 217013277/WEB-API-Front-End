...
const DogEditForm = props => {
	...
	const nameRules = [{ required: true, message: 'Please input a name' }];

	const dateRules = [{ type: 'date', message: 'input invalid' }];

	const breedRules = [{ required: true, message: 'Please input a breed' }];
